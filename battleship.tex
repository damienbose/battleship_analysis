...
%we have no idea if the 3 adjacent tiles are a ship or not, but we can encorporate that in our montecarlo

%concept that it might be better to keep checking adjacent tiles since exploding a ship will allow us to keep playing.
